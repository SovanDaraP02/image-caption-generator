...
def test_shapes():
    ...
    context, alpha = attention(torch.randn(B, num_regions, encoder_dim), torch.randn(B, decoder_dim))
...
def test_weights_sum_to_one():
    ...
    _, alpha = attention(torch.randn(B, num_regions, encoder_dim), torch.randn(B, decoder_dim))
